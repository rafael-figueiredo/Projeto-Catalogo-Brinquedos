    ...
    <div class="row row-cols-1 row-cols-md-3 g-3 ">
	 <%
			String id = request.getParameter("id");
	   		List<Produto> produtos = new ServletProduto().procurarProdutosPorIdCartegoria(Integer.parseInt(id));		
...
body,
#home {
   background: url(imgs/fundocategoria.jpg) no-repeat;
   height: 75%;
}
